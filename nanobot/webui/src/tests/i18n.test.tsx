...
const LOCALIZED_SETTINGS_COPY_KEYS = [
  ...
  "settings.skills.manageTitle",
  "settings.skills.manageDescription",
  "settings.skills.uploadDrop",
  "settings.skills.uploadFormats",
  "settings.skills.uploading",
  "settings.skills.uploadSuccess",
  "settings.skills.uploadSuccessUpdated",
  "settings.skills.uploadSuccessWithNotice",
  "settings.skills.uploadSuccessUpdatedWithNotice",
  "settings.skills.overwriteTitle",
  "settings.skills.overwriteDescription",
  "settings.skills.overwriteCancel",
  "settings.skills.overwriteConfirm",
  "settings.skills.deleteAction",
  "settings.skills.deleteTitle",
  "settings.skills.deleteDescription",
  "settings.skills.deleteCancel",
  "settings.skills.deleteConfirm",
  "settings.skills.deleting",
  "settings.skills.deleteSuccess",
  "settings.skills.errors.invalidFile",
  "settings.skills.errors.invalidPath",
  "settings.skills.errors.invalidSkill",
  "settings.skills.errors.conflict",
  "settings.skills.errors.forbidden",
  "settings.skills.errors.notFound",
  "settings.skills.errors.size",
  "settings.skills.errors.decode",
  "settings.skills.errors.failed",
  "settings.skills.errors.refresh",
  "settings.skills.errors.singleFile",
...
const BOOT_COPY_MARKUP = '<span data-boot-copy>Loading PP Agent…</span>';
