...
export interface UIMediaAttachment {
  ...
  url?: string;
  name?: string;
  /** Workspace path for previewable file attachments (docx/xlsx/pptx/pdf...). */
  path?: string;
}
...
export interface ChatSummary {
  ...
  /** Per-chat LightRAG knowledge-base selection (server-persisted, restored on reload). */
...
export type InboundEvent =
  ...
  | ({
      ...
      reply_to?: string;
      media?: string[];
      media_urls?: Array<{ url: string; name?: string; path?: string }>;
  ...
  | { event: "file_saved"; request_id: string; path?: string }
  | {
...
export type FilePreviewBinaryPayload = Extract<FilePreviewPayload, { kind: "binary" }>;
...
export type Outbound =
  ...
  | { type: "set_lightrag_workspaces"; chat_id: string; lightrag_workspaces: string[] }
