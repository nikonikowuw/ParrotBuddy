...
if TYPE_CHECKING:
    ...
    from nanobot.agent.tools.lightrag import LightRagToolConfig
...
class ToolsConfig(Base):
    ...
    lightrag: LightRagToolConfig = Field(
        default_factory=lambda: _lazy_default("nanobot.agent.tools.lightrag", "LightRagToolConfig"),
    )
...
def _resolve_tool_config_refs() -> None:
    ...
    mod.LightRagToolConfig = LightRagToolConfig  # type: ignore[attr-defined]
