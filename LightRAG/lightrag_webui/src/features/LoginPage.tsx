...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Get previous username from scopedStorage
      const previousUsername = scopedStorage.getItem('LIGHTRAG-PREVIOUS-USER')
      ...
      scopedStorage.setItem('LIGHTRAG-PREVIOUS-USER', username)
